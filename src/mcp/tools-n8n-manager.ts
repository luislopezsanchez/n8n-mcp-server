  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        nodeName: {
          type: 'string',
          description: 'Name of the node to retrieve (e.g., "Integrar Ticket ID Alto")',
        },
        fields: {
          type: 'array',
          items: { type: 'string' },
          description: 'Optional: specific parameter fields to return (e.g., ["parameters.jsCode", "parameters.model"]). If omitted, returns all parameters.',
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        nodeName: {
          type: 'string',
          description: 'Name of the node (e.g., "Integrar Ticket ID Alto")',
        },
        fieldPath: {
          type: 'string',
          description: 'Dot-separated path to the field (e.g., "parameters.jsCode", "parameters.model")',
        },
      },
      required: ['workflowId', 'nodeName', 'fieldPath'],
    },
    annotations: {
      title: 'Read Node Field',
      readOnlyHint: true,
      idempotentHint: true,
    },
  },
